...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            ...
            <p class="text-sm text-brex-pewter mt-1">Daftar lokasi penjemputan dan penurunan penumpang per rute.</p>
        </div>
                    ...
                    @forelse ($pickupPoints as $point)
                        <tr class="hover:bg-brex-fog/50 transition-colors">
                            <td class="py-4 px-6 font-medium text-brex-ink">
                                {{ $point->route ? $point->route->kota_asal . ' - ' . $point->route->kota_tujuan : '-' }}
                            </td>
